...
def read_i3_files(filenames_list, variable_list):
    output_cnn = []
    output_labels = []
    output_reco_labels = []
    output_weights = []
...
output_cnn, output_labels, output_reco_labels, output_info, output_weights, input_features_DC, input_features_IC= read_i3_files(event_file_names,variable_list)
