...
def make_network(X_DC,X_IC,num_labels,DC_drop_value,IC_drop_value,connected_drop_value):
    ...
    batch1_DC = tfa.layers.InstanceNormalization()(conv1_DC)
    ...
    batch1_IC = tfa.layers.InstanceNormalization()(conv1_IC)
    ...
    batch2_IC = tfa.layers.InstanceNormalization()(conv2_IC)
    ...
    batch3_IC = tfa.layers.InstanceNormalization()(conv3_IC)
    ...
    batch4_IC = tfa.layers.InstanceNormalization()(conv4_IC)
    ...
    batch1_full = tfa.layers.InstanceNormalization()(full1)
