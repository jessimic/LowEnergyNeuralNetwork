        ...
        for frame in event_file:
            if frame.Stop == icetray.I3Frame.Physics:
                ...
                try:
                    ...
                    isTrack = interaction_type ==1.   # it is a cascade with a trac
                    isCascade = interaction_type ==2. # it is just a cascade
                    isCC = interaction_type==1.
                    isNC = interaction_type==2.
