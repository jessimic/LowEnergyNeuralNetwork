...
max_energy_cut = 60.
cut_energy = max_energy_cut/100.
print("HARD CODED CUTTING AT %.1f GeV ASSUMING ENERGY/100GeV FOR OUTPUT VALUES!!!!!!!!!!!"%(max_energy_cut))
...
for epoch in range(start_epoch,end_epoch):
    ...
    e_train_mask = Y_train_use[:,0] < cut_energy
    e_val_mask = Y_val_use[:,0] < cut_energy
...
e_test_mask = Y_test_use[:,0] < cut_energy
