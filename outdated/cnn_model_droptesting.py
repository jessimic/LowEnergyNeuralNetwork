...
## CNN NETWORK ##
def make_network(X_DC,X_IC,num_labels,DC_drop_value,IC_drop_value,connected_drop_value,drop_testing=True):
	...
	dropf = Dropout(connected_drop_value)(batch1_full,training=drop_testing)
