...
do
    FILENUM=`printf "%02d\n" $THOUS`
    #infile=oscNext_muongun_level6_flercnn_pass2.${SET}.0${FILENUM}???.i3.zst_cleanedpulses_transformed_IC19.hdf5
    #name=oscNext_muongun_level6_flercnn_pass2.${SET}.${FILENUM}k_cleanedpulses_transformed_IC19
