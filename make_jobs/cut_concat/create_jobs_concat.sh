...
do
    ...
    infile=oscNext_muongun_level4_v02.00_pass2.${SET}.00${FILENUM}??.i3.zst_cleanedpulses_transformed_IC19.hdf5
    name=oscNext_muongun_level4_v02.00_pass2.${SET}.${FILENUM}h_cleanedpulses_transformed_IC19
