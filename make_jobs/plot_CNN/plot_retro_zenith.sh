...
NAME=zenith_numu_flat_5_150_CC_26659evtperbin_IC19_oldstartDC_lrEpochs50
TEST=$2
VARIABLE="zenith"
EPOCH=152

singularity exec -B /mnt/home/micall12:/mnt/home/micall12 -B /mnt/research/IceCube:/mnt/research/IceCube --nv /mnt/research/IceCube/Software/icetray_stable-tensorflow.sif python ${OUTDIR}CNN_TestOnly.py -i $INPUT -d $INDIR -o $OUTDIR --name $NAME --epoch $EPOCH -t $TEST --first_variable $VARIABLE --compare_reco
