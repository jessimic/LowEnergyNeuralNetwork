...
#SBATCH --output /mnt/home/micall12/LowEnergyNeuralNetwork/make_jobs/plot_CNN/plot_epoch_zenith.out
...
NAME="numu_flat_Z_5_100_CC_uncleaned_cleanedpulsesonly_3600kevents_nologcharge_IC19_lrEpochs50"
#EPOCH=406
TEST="oscnext"
VARIABLE="zenith"

#98 203 301 399 504 602 700 798 
for EPOCH in 98 203 301 399 504 602 700 777;
do
