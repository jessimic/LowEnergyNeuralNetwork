...
#INPUTFILES="/mnt/research/IceCube/jmicallef/official_oscnext/level6/1[2,4]0000/oscNext_genie_level7_v02.00_pass2.1[2,4]0000.*.i3.zst"
INPUTFILES="/mnt/research/IceCube/jmicallef/official_oscnext/level6/1[2,4]0000/oscNext_genie_level6.5_v02.00_pass2.140000.*.i3.zst"
...
do
    ...
    sed -e "s|@@file@@|${file}|g" \
        ...
        -e "s|@@variable2@@|${VARIABLE2}|g" \
        -e "s|@@model_name3@@|${MODEL_NAME3}|g" \
        -e "s|@@variable3@@|${VARIABLE3}|g" \
