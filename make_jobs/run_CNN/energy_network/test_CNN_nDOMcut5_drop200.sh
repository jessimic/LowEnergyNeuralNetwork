...
#SBATCH --output /mnt/home/micall12/LowEnergyNeuralNetwork/make_jobs/run_CNN/energy_network/CNN_energy_20k_nDOMcut5_drop200.out

########## Command Lines to Run ##########

EPOCH=522
MODEL=energy_numu_level6_cleanedpulses_IC19_E1to500_20000evtperbin_no8hitcut_LRe-3DROPe-.5EPOCHS200_nDOMcut5

singularity exec -B /mnt/home/micall12:/mnt/home/micall12 -B /mnt/research/IceCube:/mnt/research/IceCube --nv /mnt/research/IceCube/Software/icetray_stable-tensorflow.sif python /mnt/home/micall12/LowEnergyNeuralNetwork/CNN_Test_hdf5.py -i oscNext_genie_level6_flercnn_pass2.140000.00-03h.cleanedpulses_transformed_IC19.no_cuts.test_only.hdf5 -d /mnt/research/IceCube/jmicallef/DNN_files/testing/ -o /mnt/home/micall12/LowEnergyNeuralNetwork/output_plots/${MODEL}/ -n prediction_values_${EPOCH}epochs --variable_list energy --epoch_list ${EPOCH} --modelname_list ${MODEL}
