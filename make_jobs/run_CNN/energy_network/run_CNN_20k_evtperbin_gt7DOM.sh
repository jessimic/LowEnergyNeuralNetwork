...
#SBATCH --output /mnt/home/micall12/LowEnergyNeuralNetwork/make_jobs/run_CNN/energy_network/CNN_energy_no8hitcut_20k_nDOM7.out
...
LR=0.001
DOMS=7
OUTNAME="energy_numu_level6_cleanedpulses_IC19_E1to500_20000evtperbin_no8hitcut_LRe-3DROPe-.5EPOCHS${LR_EPOCH}_nDOMcut${DOMS}"
