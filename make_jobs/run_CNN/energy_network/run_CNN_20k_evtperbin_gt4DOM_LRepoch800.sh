...
#SBATCH --output /mnt/home/micall12/LowEnergyNeuralNetwork/make_jobs/run_CNN/energy_network/CNN_energy_no8hitcut_20k_nDOM4_LRepoch800.out
...
LR_DROP=0.5
LR=0.001
OUTNAME="energy_numu_level6_cleanedpulses_IC19_E1to500_20000evtperbin_no8hitcut_LRe-3DROPe-.5EPOCHS${LR_EPOCH}_nDOMcut4"
