...
#SBATCH --output /mnt/home/micall12/LowEnergyNeuralNetwork/make_jobs/run_CNN/CNN_energy_extended4_40k_LRepoch400_start396.out
...
LR_DROP=0.5
LR=0.001
OUTNAME="energy_numu_level6_cleanedpulses_IC19_E1to500_40000evtperbin_extended4_LRe-3DROPe-.5EPOCHS${LR_EPOCH}_start396"
