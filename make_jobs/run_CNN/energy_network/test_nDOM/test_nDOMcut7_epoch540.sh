...
#SBATCH --output /mnt/home/micall12/LowEnergyNeuralNetwork/make_jobs/run_CNN/energy_network/test_nDOM/CNN_energy_20k_nDOMcut7_epoch540.out

########## Command Lines to Run ##########

EPOCH=540
MODEL=energy_numu_level6_cleanedpulses_IC19_E1to500_20000evtperbin_no8hitcut_LRe-3DROPe-.5EPOCHS200_nDOMcut7
