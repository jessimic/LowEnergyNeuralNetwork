...
#SBATCH --output /mnt/home/micall12/LowEnergyNeuralNetwork/make_jobs/run_CNN//CNN_Muon_3mill_nDOMcut4.out
...
MUON_EPOCH=108
MUON2=MuonClassification_level4_3millevents_130000_10k_nDOM4
MUON_EPOCH2=108
MUON_EPOCH3=114
MUON_EPOCH4=120
MUON_EPOCH5=126
